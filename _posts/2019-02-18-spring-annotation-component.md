...
* 包扫描+组件标注注解（**@Controller**/**@Service**/**@Repository**/**@Component**）[<font color=red>自己写的类</font>]
* **@Bean**[<font color=red>导入的第三方包里面的组件</font>]  
* **@Import**[<font color=red>快速给容器中导入一个组件</font>]  
